...
exports.otherCompressRanges = exports.compressRanges = void 0;
/**
...
function otherCompressRanges(arr) {
    if (arr.length === 0)
        return ""; // 1. Краевой случай: пустой массив
...
exports.otherCompressRanges = otherCompressRanges;
